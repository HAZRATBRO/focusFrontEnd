...
@Component({
  selector: 'app-sample-quiz',
  templateUrl: './sample-quiz.component.html',
  styleUrls: ['./sample-quiz.component.css'],
  animations:[
    trigger('EnterLeave', [
...
export class SampleQuizComponent implements OnInit {
...
@HostListener('window:keydown', ['$event'])
 ...
 ngOnInit(): void {
   ...
   this.service.getSampleTest().subscribe((data: any)=>{
